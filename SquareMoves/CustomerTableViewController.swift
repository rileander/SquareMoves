...
//  SquareMoves
//
//  Created by Lindsey pollock on 5/2/17.
...
class CustomerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationLabel.title = String(timeString)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let bars = self.bars[indexPath.row] as Bars
        cell.textLabel?.text = bars.barName
        cell.detailTextLabel?.text = bars.barHours
